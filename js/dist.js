...
if (
  ((function (t, e) {
    ...
    function r(t) {
      var e = (bt[t] = {});
      return (
        ot.each(t.match(yt) || [], function (t, n) {
          e[n] = !0;
        }),
        e
      );
    ...
    function s() {
      ht.addEventListener
        ? (ht.removeEventListener("DOMContentLoaded", a, !1),
          t.removeEventListener("load", a, !1))
        : (ht.detachEvent("onreadystatechange", a), t.detachEvent("onload", a));
    }
    function a() {
      (ht.addEventListener ||
        "load" === event.type ||
    ...
    function c(t, e, n, i) {
      if (ot.acceptData(t)) {
        ...
        if (
          ...
          return (
            u || (u = a ? (t[s] = X.pop() || ot.guid++) : s),
            l[u] || (l[u] = a ? {} : { toJSON: ot.noop }),
            ("object" == typeof e || "function" == typeof e) &&
              (i
                ? (l[u] = ot.extend(l[u], e))
                : (l[u].data = ot.extend(l[u].data, e))),
            (r = l[u]),
            i || (r.data || (r.data = {}), (r = r.data)),
            void 0 !== n && (r[ot.camelCase(e)] = n),
            "string" == typeof e
              ? null == (o = r[e]) && (o = r[ot.camelCase(e)])
              : (o = r),
            o
          );
      }
        ...
        if (s[a]) {
          if (e && (i = n ? s[a] : s[a].data)) {
            ot.isArray(e)
              ...
              : e in i
              ? (e = [e])
              : ((e = ot.camelCase(e)), (e = e in i ? [e] : e.split(" "))),
              (o = e.length);
            for (; o--; ) delete i[e[o]];
            if (n ? !u(i) : !ot.isEmptyObject(i)) return;
          }
          (n || (delete s[a].data, u(s[a]))) &&
            (r
              ? ot.cleanData([t], !0)
              : nt.deleteExpando || s != s.window
              ? delete s[a]
              : (s[a] = null));
        }
      }
    ...
    function g(t, e) {
      var n,
        ...
        o = 0,
        r =
          typeof t.getElementsByTagName !== Tt
            ? t.getElementsByTagName(e || "*")
            : typeof t.querySelectorAll !== Tt
    ...
    function C(t, e) {
      ...
      if (1 === e.nodeType) {
        if (
          ((n = e.nodeName.toLowerCase()), !nt.noCloneEvent && e[ot.expando])
        ) {
          o = ot._data(e);
    ...
    function E(e, n) {
      var i,
        o = ot(n.createElement(e)).appendTo(n.body),
        r =
    ...
    function L(t, e) {
      if (e in t) return e;
      for (
        var n = e.charAt(0).toUpperCase() + e.slice(1), i = e, o = pe.length;
        o--;
    ...
    function N(t, e) {
      for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++)
        (i = t[s]),
          i.style &&
            ((r[s] = ot._data(i, "olddisplay")),
            (n = i.style.display),
            e
              ? (r[s] || "none" !== n || (i.style.display = ""),
                "" === i.style.display &&
                  Lt(i) &&
                  (r[s] = ot._data(i, "olddisplay", S(i.nodeName))))
              : ((o = Lt(i)),
                ((n && "none" !== n) || !o) &&
                  ot._data(i, "olddisplay", o ? n : ot.css(i, "display"))));
      for (s = 0; a > s; s++)
        (i = t[s]),
          i.style &&
    ...
    function $(t, e, n, i, o) {
      for (
        ...
        "margin" === n && (s += ot.css(t, n + kt[r], !0, o)),
          i
            ? ("content" === n && (s -= ot.css(t, "padding" + kt[r], !0, o)),
              "margin" !== n &&
                (s -= ot.css(t, "border" + kt[r] + "Width", !0, o)))
            : ((s += ot.css(t, "padding" + kt[r], !0, o)),
              "padding" !== n &&
                (s += ot.css(t, "border" + kt[r] + "Width", !0, o)));
      return s;
    }
    ...
    function I(t, e) {
      ...
      for (e = e ? 1 : 0; 4 > o; o += 2 - e)
        (n = kt[o]), (i["margin" + n] = i["padding" + n] = t);
      return e && (i.opacity = i.width = t), i;
    }
    function O(t, e, n) {
      for (
        var i, o = (ye[e] || []).concat(ye["*"]), r = 0, s = o.length;
        s > r;
        r++
      )
    ...
    function z(t, e, n) {
      ...
      n.queue ||
        ...
        1 === t.nodeType &&
          ...
          (u = ot.css(t, "display")),
          "inline" ===
            ("none" === u ? ot._data(t, "olddisplay") || S(t.nodeName) : u) &&
            "none" === ot.css(t, "float") &&
            (nt.inlineBlockNeedsLayout && "inline" !== S(t.nodeName)
              ? (d.zoom = 1)
            ...
            if (null != (o = arguments[a]))
              for (i in o)
                (t = s[i]),
                  (n = o[i]),
                  s !== n &&
                    (u && n && (ot.isPlainObject(n) || (e = ot.isArray(n)))
                      ? (e
                          ? ((e = !1), (r = t && ot.isArray(t) ? t : []))
                          : (r = t && ot.isPlainObject(t) ? t : {}),
                        (s[i] = ot.extend(u, r, n)))
                      : void 0 !== n && (s[i] = n));
          return s;
        }),
      ot.extend({
        ...
        makeArray: function (t, e) {
          ...
          return (
            null != t &&
              (n(Object(t))
                ? ot.merge(i, "string" == typeof t ? [t] : t)
                : J.call(i, t)),
            i
          );
        },
    ...
    var ut = (function (t) {
          ...
          if (b.qsa && (!j || !j.test(t))) {
            if (
              ...
              for (
                ...
                p[u] = f + c(p[u]);
              (h = (vt.test(t) && l(e.parentNode)) || e), (m = p.join(","));
            }
            if (m)
              try {
        ...
        return (
          ...
          i(function (i, s, a, l) {
            var u,
              ...
              b = n ? (r || (i ? t : g || o) ? [] : s) : y;
            if ((n && n(y, b, a, l), o))
              for (u = h(b, m), o(u, [], a, l), c = u.length; c--; )
                (p = u[c]) && (b[m[c]] = !(y[m[c]] = p));
            if (i) {
              if (r || t) {
                if (r) {
      ...
      (b = e.support = {}),
            ...
            return n !== $ && 9 === n.nodeType && n.documentElement
              ? (($ = n),
                ...
                (x.find.CLASS =
                  b.getElementsByClassName &&
                  function (t, e) {
                    return typeof e.getElementsByClassName !== U && A
                      ? e.getElementsByClassName(t)
                      : void 0;
                  }),
                (I = []),
                (j = []),
                (b.qsa = mt.test(n.querySelectorAll)) &&
                  (o(function (t) {
                    (t.innerHTML =
                  ...
                  ? function (t, e) {
                      ...
                      return (
                        ...
                        (!b.sortDetached && e.compareDocumentPosition(t) === i)
                          ? t === n || (t.ownerDocument === M && z(M, t))
                            ? -1
                            : e === n || (e.ownerDocument === M && z(M, e))
                            ? 1
                            : L
                            ? Z.call(L, t) - Z.call(L, e)
                            : 0
                          : 4 & i
                          ? -1
                          : 1)
        ...
        (e.contains = function (t, e) {
          return (t.ownerDocument || t) !== $ && _(t), z(t, e);
        }),
        (e.attr = function (t, e) {
          (t.ownerDocument || t) !== $ && _(t);
          var n = x.attrHandle[e.toLowerCase()],
            i =
              n && Q.call(x.attrHandle, e.toLowerCase()) ? n(t, e, !A) : void 0;
          return void 0 !== i
            ? i
            : b.attributes || !A
            ? t.getAttribute(e)
          ...
          function (t, e) {
            ...
            if (!r) {
              for (e || (e = C(t)), n = e.length; n--; )
                (r = g(e[n])), r[H] ? i.push(r) : o.push(r);
              (r = q(t, v(o, i))), (r.selector = t);
            }
            return r;
          }),
        (S = e.select =
            ...
            if (((n = n || []), 1 === d.length)) {
              ...
              for (
                ...
                if (
                  ...
                  if ((r.splice(o, 1), !(t = i.length && c(r))))
                    return J.apply(n, i), n;
                  break;
                }
            }
            return (
              (p || E(t, d))(i, e, !A, n, (vt.test(t) && l(e.parentNode)) || e),
              n
            );
          }),
    ...
    (ot.filter = function (t, e, n) {
      ...
      ot.fn.extend({
        find: function (t) {
          ...
          return (
            (n = this.pushStack(o > 1 ? ot.unique(n) : n)),
    ...
    ot.extend({
      dir: function (t, e, n) {
        for (
          ...
          o &&
          9 !== o.nodeType &&
          (void 0 === n || 1 !== o.nodeType || !ot(o).is(n));
        ...
        function (t, e) {
          ot.fn[t] = function (n, i) {
            ...
            return (
              ...
              this.length > 1 &&
                (vt[t] || (o = ot.unique(o)), gt.test(t) && (o = o.reverse())),
              this.pushStack(o)
            );
          };
        }
    ...
    (ot.Callbacks = function (t) {
      ...
      var e,
        ...
        c = function (r) {
          for (
            n = t.memory && r, i = !0, s = a || 0, a = 0, o = l.length, e = !0;
            l && o > s;
            s++
          )
        ...
        p = {
          ...
          remove: function () {
            return (
              l &&
                ot.each(arguments, function (t, n) {
                  for (var i; (i = ot.inArray(n, l, i)) > -1; )
                    l.splice(i, 1), e && (o >= i && o--, s >= i && s--);
                }),
              this
            );
          },
      ...
      ot.extend({
        ...
        ready: function (t) {
          if (!0 === t ? !--ot.readyWait : !ot.isReady) {
            ...
            (ot.isReady = !0),
              (!0 !== t && --ot.readyWait > 0) ||
                (xt.resolveWith(ht, [ot]),
                ot.fn.triggerHandler &&
                  (ot(ht).triggerHandler("ready"), ot(ht).off("ready")));
          }
        },
      }),
      (ot.ready.promise = function (e) {
        if (!xt)
          if (((xt = ot.Deferred()), "complete" === ht.readyState))
            setTimeout(ot.ready);
    ...
    ot.extend({
      ...
      hasData: function (t) {
        return (
          !!(t = t.nodeType ? ot.cache[t[ot.expando]] : t[ot.expando]) && !u(t)
        );
      },
      data: function (t, e, n) {
        return c(t, e, n);
    ...
    (ot.event = {
                ...
                ((c = g.handle =
                  function (t) {
                    return typeof ot === Tt ||
                      ...
                      ? void 0
                      : ot.event.dispatch.apply(c.elem, arguments);
                  }),
                (c.elem = t)),
              e = (e || "").match(yt) || [""],
              a = e.length;
        ...
        if (g && (c = g.events)) {
          for (e = (e || "").match(yt) || [""], u = e.length; u--; )
            if (
              ...
              l &&
                !d.length &&
                ((p.teardown && !1 !== p.teardown.call(t, h, g.handle)) ||
                  ot.removeEvent(t, f, g.handle),
                delete c[f]);
            } else for (f in c) ot.event.remove(t, f + e[u], n, i, !0);
      ...
      trigger: function (e, n, i, o) {
        ...
        if (
          ...
          3 !== i.nodeType &&
            8 !== i.nodeType &&
            !jt.test(f + ot.event.triggered) &&
            (f.indexOf(".") >= 0 &&
              ((h = f.split(".")), (f = h.shift()), h.sort()),
            (s = f.indexOf(":") < 0 && "on" + f),
            (e = e[ot.expando]
              ? e
              : new ot.Event(f, "object" == typeof e && e)),
            (e.isTrigger = o ? 2 : 3),
            (e.namespace = h.join(".")),
          ...
          if (!o && !u.noBubble && !ot.isWindow(i)) {
            for (
              l = u.delegateType || f, jt.test(l + f) || (a = a.parentNode);
              a;
              a = a.parentNode
            )
              d.push(a), (c = a);
            c === (i.ownerDocument || ht) &&
              d.push(c.defaultView || c.parentWindow || t);
          }
          for (p = 0; (a = d[p++]) && !e.isPropagationStopped(); )
            (e.type = p > 1 ? l : u.bindType || f),
              (r =
                (ot._data(a, "events") || {})[e.type] && ot._data(a, "handle")),
              r && r.apply(a, n),
              (r = s && a[s]) &&
                r.apply &&
                ot.acceptData(a) &&
          ...
          if (
            ...
            !o &&
              ...
              (!u._default || !1 === u._default.apply(d.pop(), n)) &&
              ot.acceptData(i) &&
              s &&
              i[f] &&
              !ot.isWindow(i))
          ...
          for (
            ...
            for (
              ...
              (!t.namespace_re || t.namespace_re.test(i.namespace)) &&
                ...
                void 0 !==
                  (n = (
                    (ot.event.special[i.origType] || {}).handle || i.handler
                  ).apply(o.elem, a)) &&
                  !1 === (t.result = n) &&
      ...
      fix: function (t) {
        ...
        for (
          s ||
            (this.fixHooks[o] = s =
              At.test(o) ? this.mouseHooks : Dt.test(o) ? this.keyHooks : {}),
          ...
          (n = i[e]), (t[n] = r[n]);
        return (
          t.target || (t.target = r.srcElement || ht),
      ...
      (ot.removeEvent = ht.removeEventListener
        ...
        : function (t, e, n) {
            var i = "on" + e;
            t.detachEvent &&
              (typeof t[i] === Tt && (t[i] = null), t.detachEvent(i, n));
          }),
              ...
              void ot.event.add(
                ...
                function (t) {
                  ...
                  n &&
                    ...
                    (ot.event.add(n, "submit._submit", function (t) {
                      t._submit_bubble = !0;
                    }),
        ...
        ot.each({ focus: "focusin", blur: "focusout" }, function (t, e) {
          ...
          ot.event.special[e] = {
            ...
            teardown: function () {
              ...
              o
                ? ot._data(i, e, o)
                : (i.removeEventListener(t, n, !0), ot._removeData(i, e));
            },
          };
        }),
      ot.fn.extend({
    ...
    (Xt.optgroup = Xt.option),
      ...
      ot.extend({
        clone: function (t, e, n) {
          ...
          if (
            (nt.html5Clone || ot.isXMLDoc(t) || !Ht.test("<" + t.nodeName + ">")
              ? (r = t.cloneNode(!0))
          ...
          if (e)
            if (n)
              for (a = a || g(t), i = i || g(r), s = 0; null != (o = a[s]); s++)
                T(o, i[s]);
            else T(t, r);
          return (
            (i = g(r, "script")),
        ...
        buildFragment: function (t, e, n, i) {
          for (
            var o, r, s, a, l, u, c, p = t.length, d = m(e), f = [], h = 0;
            p > h;
            h++
          )
            if ((r = t[h]) || 0 === r)
              if ("object" === ot.type(r)) ot.merge(f, r.nodeType ? [r] : r);
                ...
                if (
                  (!nt.leadingWhitespace &&
                    Mt.test(r) &&
                    f.push(e.createTextNode(Mt.exec(r)[0])),
                  !nt.tbody)
                )
                  for (
                    r =
                    ...
                    ot.nodeName((u = r.childNodes[o]), "tbody") &&
                      !u.childNodes.length &&
                      r.removeChild(u);
                for (
                  ot.merge(f, a.childNodes), a.textContent = "";
                  a.firstChild;
          ...
          for (
            ...
            if (
              (!i || -1 === ot.inArray(r, i)) &&
              ((s = ot.contains(r.ownerDocument, r)),
      ...
      ot.fn.extend({
          ...
          return Nt(
            ...
            function (t) {
              return void 0 === t
                ? ot.text(this)
                : this.empty().append(
                    ((this[0] && this[0].ownerDocument) || ht).createTextNode(t)
                  );
            },
            null,
            t,
        ...
        remove: function (t, e) {
          for (
            var n, i = t ? ot.filter(t, this) : this, o = 0;
            null != (n = i[o]);
            o++
          )
            e || 1 !== n.nodeType || ot.cleanData(g(n)),
              n.parentNode &&
                (e && ot.contains(n.ownerDocument, n) && w(g(n, "script")),
            ...
            function (t) {
              ...
              if (
                !(
                  "string" != typeof t ||
                  qt.test(t) ||
                  (!nt.htmlSerialize && Ht.test(t)) ||
                  (!nt.leadingWhitespace && Mt.test(t)) ||
                  Xt[(Rt.exec(t) || ["", ""])[1].toLowerCase()]
                )
              ) {
                t = t.replace(Wt, "<$1></$2>");
                try {
        ...
        domManip: function (t, e) {
          ...
          if (
            f ||
            (u > 1 && "string" == typeof d && !nt.checkClone && Bt.test(d))
          )
          ...
          if (
            u &&
            ((a = ot.buildFragment(t, this[0].ownerDocument, !1, this)),
            (n = a.firstChild),
            1 === a.childNodes.length && (a = n),
            n)
          ) {
            for (r = ot.map(g(a, "script"), b), o = r.length; u > l; l++)
              (i = a),
                l !== p &&
                  ((i = ot.clone(i, !0, !0)), o && ot.merge(r, g(i, "script"))),
                e.call(this[l], i, l);
            if (o)
              for (
                s = r[r.length - 1].ownerDocument, ot.map(r, x), l = 0;
                o > l;
                l++
              )
                (i = r[l]),
                  Ut.test(i.type || "") &&
                    !ot._data(i, "globalEval") &&
                    ot.contains(s, i) &&
                    (i.src
                      ? ot._evalUrl && ot._evalUrl(i.src)
                      : ot.globalEval(
                          (
                            i.text ||
                            i.textContent ||
    ...
    ot.extend({
      ...
      style: function (t, e, n, i) {
        if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
          var o,
            ...
            l = t.style;
          if (
            ((e = ot.cssProps[a] || (ot.cssProps[a] = L(l, a))),
          ...
          if (
            ...
            "string" === r &&
              (o = le.exec(n)) &&
              ((n = (o[1] + 1) * o[2] + parseFloat(ot.css(t, e))),
              (r = "number")),
            null != n &&
              n === n &&
              ("number" !== r || ot.cssNumber[a] || (n += "px"),
              nt.clearCloneStyle ||
                "" !== n ||
      ...
      css: function (t, e, n, i) {
        var o,
          ...
          a = ot.camelCase(e);
        return (
          (e = ot.cssProps[a] || (ot.cssProps[a] = L(t.style, a))),
          (s = ot.cssHooks[e] || ot.cssHooks[a]),
          s && "get" in s && (r = s.get(t, !0, n)),
          void 0 === r && (r = te(t, e, i)),
          "normal" === r && e in ce && (r = ce[e]),
          "" === n || n
            ? ((o = parseFloat(r)), !0 === n || ot.isNumeric(o) ? o || 0 : r)
            : r
        );
      },
    }),
      ot.each(["height", "width"], function (t, e) {
        ot.cssHooks[e] = {
          get: function (t, n, i) {
            return n
              ? se.test(ot.css(t, "display")) && 0 === t.offsetWidth
                ? ot.swap(t, ue, function () {
                    return D(t, e, i);
                  })
                : D(t, e, i)
              : void 0;
      ...
      nt.opacity ||
        (ot.cssHooks.opacity = {
          ...
          set: function (t, e) {
            ...
            (n.zoom = 1),
              ((e >= 1 || "" === e) &&
                "" === ot.trim(r.replace(oe, "")) &&
                n.removeAttribute &&
                (n.removeAttribute("filter"), "" === e || (i && !i.filter))) ||
                (n.filter = oe.test(r) ? r.replace(oe, o) : r + " " + o);
          },
        }),
      (ot.cssHooks.marginRight = k(nt.reliableMarginRight, function (t, e) {
        return e
          ? ot.swap(t, { display: "inline-block" }, te, [t, "marginRight"])
          : void 0;
      })),
        ...
        "*": [
          function (t, e) {
            var n = this.createTween(t, e),
              ...
              s =
                (ot.cssNumber[t] || ("px" !== r && +i)) &&
                me.exec(ot.css(n.elem, t)),
              a = 1,
              l = 20;
            if (s && s[3] !== r) {
              (r = r || s[3]), (o = o || []), (s = +i || 1);
    ...
    (ot.Animation = ot.extend(M, {
      tweener: function (t, e) {
        ...
        for (var n, i = 0, o = t.length; o > i; i++)
          (n = t[i]), (ye[n] = ye[n] || []), ye[n].unshift(e);
      },
        ...
        return arguments.length
          ...
          ? ((e = ot.valHooks[o.type] || ot.valHooks[o.nodeName.toLowerCase()]),
            e && "get" in e && void 0 !== (n = e.get(o, "value"))
              ? n
              : ((n = o.value),
                "string" == typeof n ? n.replace(be, "") : null == n ? "" : n))
          : void 0;
      },
    }),
      ot.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function (t, e) {
              for (
                var n, i, o = t.options, r = ot.makeArray(e), s = o.length;
                s--;

              )
                if (((i = o[s]), ot.inArray(ot.valHooks.option.get(i), r) >= 0))
                  try {
                    i.selected = n = !0;
                  } catch (t) {
                    i.scrollHeight;
      ...
      ot.extend({
          ...
          if (t && 3 !== r && 8 !== r && 2 !== r)
            return typeof t.getAttribute === Tt
              ...
              : ((1 === r && ot.isXMLDoc(t)) ||
                  ((e = e.toLowerCase()),
                  (i =
                    ot.attrHooks[e] || (ot.expr.match.bool.test(e) ? we : xe))),
                void 0 === n
                  ? i && "get" in i && null !== (o = i.get(t, e))
                    ? o
                    : ((o = ot.find.attr(t, e)), null == o ? void 0 : o)
                  : null !== n
        ...
        removeAttr: function (t, e) {
          ...
          if (r && 1 === t.nodeType)
            for (; (n = r[o++]); )
              (i = ot.propFix[n] || n),
                ot.expr.match.bool.test(n)
                  ? (Se && Ee) || !Ce.test(n)
                    ? (t[i] = !1)
                    : (t[ot.camelCase("default-" + n)] = t[i] = !1)
                  : ot.attr(t, n, ""),
        ...
        set: function (t, e, n) {
          return (
            !1 === e
              ? ot.removeAttr(t, n)
              : (Se && Ee) || !Ce.test(n)
              ? t.setAttribute((!Ee && ot.propFix[n]) || n, n)
              : (t[ot.camelCase("default-" + n)] = t[n] = !0),
            n
          );
        },
      }),
      ...
      ot.extend({
        ...
        prop: function (t, e, n) {
          ...
          if (t && 3 !== s && 8 !== s && 2 !== s)
            return (
              (r = 1 !== s || !ot.isXMLDoc(t)),
              r && ((e = ot.propFix[e] || e), (o = ot.propHooks[e])),
              void 0 !== n
        ...
        propHooks: {
          tabIndex: {
            get: function (t) {
              ...
              return e
                ? parseInt(e, 10)
                : ke.test(t.nodeName) || (Le.test(t.nodeName) && t.href)
                ? 0
                : -1;
            },
          },
    ...
    ot.fn.extend({
          ...
          : this.each(
              ot.isFunction(t)
                ...
                : function () {
                    if ("string" === n)
                      for (
                        var e, i = 0, o = ot(this), r = t.match(yt) || [];
                        (e = r[i++]);
      ...
      hasClass: function (t) {
        for (var e = " " + t + " ", n = 0, i = this.length; i > n; n++)
          if (
            1 === this[n].nodeType &&
            (" " + this[n].className + " ").replace(Ne, " ").indexOf(e) >= 0
          )
            return !0;
        return !1;
      },
    ...
    (Ae = Re.exec(je.toLowerCase()) || []),
        ...
        ajax: function (t, e) {
          function n(t, e, n, i) {
            ...
            2 !== b &&
              ...
              (g = void 0),
              l &&
                f.trigger(o ? "ajaxSuccess" : "ajaxError", [w, p, o ? c : v]),
              m.fireWith(d, [w, T]),
              l &&
          ...
          var i,
            ...
            p = ot.ajaxSetup({}, e),
            d = p.context || p,
            f = p.context && (d.nodeType || d.jquery) ? ot(d) : ot.event,
            h = ot.Deferred(),
          ...
          (l = p.global),
            ...
            p.ifModified &&
              (ot.lastModified[r] &&
                w.setRequestHeader("If-Modified-Since", ot.lastModified[r]),
      ...
      ot.each(["get", "post"], function (t, e) {
        ot[e] = function (t, n, i, o) {
          return (
            ot.isFunction(n) && ((o = o || i), (i = n), (n = void 0)),
            ot.ajax({ url: t, type: e, dataType: o, data: n, success: i })
          );
        };
      }),
      ot.each(
    ...
    t.ActiveXObject &&
      ...
      ot.ajaxTransport("script", function (t) {
        if (t.crossDomain) {
          var e,
            n = ht.head || ot("head")[0] || ht.documentElement;
          return {
            send: function (i, o) {
      ...
      ot.ajaxPrefilter("json jsonp", function (e, n, i) {
        ...
        return a || "jsonp" === e.dataTypes[0]
          ? ((o = e.jsonpCallback =
            ...
            i.always(function () {
              (t[o] = r),
                e[o] && ((e.jsonpCallback = n.jsonpCallback), Ke.push(o)),
    ...
    (ot.fn.load = function (t, e, n) {
      ...
      var i,
        ...
        a = t.indexOf(" ");
      return (
        a >= 0 && ((i = ot.trim(t.slice(a, t.length))), (t = t.slice(0, a))),
        ot.isFunction(e)
          ? ((n = e), (e = void 0))
    ...
    (ot.offset = {
      ...
      ot.fn.extend({
        offset: function (t) {
          ...
          return r
            ? ((e = r.documentElement),
              ot.contains(e, o)
                ? (typeof o.getBoundingClientRect !== Tt &&
      ...
      ot.each(["top", "left"], function (t, e) {
        ot.cssHooks[e] = k(nt.pixelPosition, function (t, n) {
          return n
            ? ((n = te(t, e)), ne.test(n) ? ot(t).position()[e] + "px" : n)
            : void 0;
        });
      }),
    ...
    return (
      (ot.noConflict = function (e) {
        return (
          t.$ === ot && (t.$ = on), e && t.jQuery === ot && (t.jQuery = nn), ot
        );
      }),
        ...
        e && e.preventDefault(),
          ...
          e.isDefaultPrevented() ||
            ...
            t.support.transition && r.hasClass("fade")
              ? r.one("bsTransitionEnd", n).emulateTransitionEnd(150)
              : n());
      });
    var o = t.fn.alert;
    (t.fn.alert = e),
      ...
      t(document).on(
        ...
        function (n) {
          ...
          (a && a.transitioning) ||
            (c &&
              c
                .find('[data-toggle="collapse"][data-parent="' + u + '"]')
                .not(o)
                .addClass("collapsed"),
    ...
    (n.VERSION = "3.2.0"),
      ...
      (n.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (l) {
            ...
            (s =
              "bottom" == s && u.top + u.height + p - h.scroll > h.height
                ? "top"
                : "top" == s && u.top - h.scroll - p < 0
                ? "bottom"
                : "right" == s && u.right + c > h.width
                ? "left"
                : "left" == s && u.left - c < h.left
                ? "right"
                : s),
      ...
      (n.prototype.hide = function () {
        ...
        return (
          ...
          o.isDefaultPrevented()
            ...
            : (i.removeClass("in"),
              t.support.transition && this.$tip.hasClass("fade")
                ? i.one("bsTransitionEnd", e).emulateTransitionEnd(150)
                : e(),
      ...
      (n.prototype.getViewportAdjustedDelta = function (t, e, n, i) {
        ...
        if (/right|left/.test(t)) {
          ...
          u < s.left
            ? (o.left = s.left - u)
            : c > s.width && (o.left = s.left + s.width - c);
        }
        return o;
      }),
      ...
      (n.prototype.checkPosition = function () {
        if (this.$element.is(":visible")) {
          ...
          var l =
            ...
            (null != a && o.top + this.$element.height() >= e - a
              ? "bottom"
              : null != s && s >= i && "top");
          if (this.affixed !== l) {
            ...
            this.$element.trigger(c),
              c.isDefaultPrevented() ||
                ...
                this.$element
                  .removeClass(n.RESET)
                  .addClass(u)
                  .trigger(t.Event(u.replace("affix", "affixed"))),
                "bottom" == l &&
                  this.$element.offset({
    ...
    function i(t) {
      function i(t) {
        if (
          ...
          for (
            var c = (o.isBorderBox = !(!u || !i[u] || "border-box" !== i[u])),
              p = 0,
              d = s.length;
            d > p;
            p++
    ...
    function s(n, s, p, f, h, m) {
      ...
      return (
          ...
          for (
            ...
            if (d(s))
              if (e) {
                h(s, e) && n.push(s);
                for (
                  var a = s.querySelectorAll(e), l = 0, u = a.length;
                  u > l;
                  l++
                )
                  n.push(a[l]);
        ...
        (g.prototype._itemsOn = function (t, e, n) {
          ...
          for (
            var o = 0, r = t.length, s = this, a = 0, l = t.length;
            l > a;
            a++
          ) {
            t[a].on(e, i);
        ...
        init: function () {
          ...
          (this.elems = Array.prototype.slice.call(
            ...
            this.elems.forEach(function (t, i) {
              ...
              o || ((o = n++), t.setAttribute("data-scroll-reveal-id", o)),
          ...
          this.docElem == t.document.documentElement
            ? (t.addEventListener("scroll", o, !1),
              t.addEventListener("resize", r, !1))
            : this.docElem.addEventListener("scroll", o, !1);
        },
          ...
          return (
            ...
            e.forEach(function (t, i) {
              switch (t) {
                ...
                case "ease":
                  return (n.move = e[i + 1]), void (n.ease = "ease");
                case "ease-in":
                  return (n.move = e[i + 1]), void (n.easing = "ease-in");
                case "ease-in-out":
                  return (n.move = e[i + 1]), void (n.easing = "ease-in-out");
                case "ease-out":
                  return (n.move = e[i + 1]), void (n.easing = "ease-out");
                case "over":
        ...
        update: function (t) {
          ...
          return (
            ...
            t.getAttribute("data-scroll-reveal-initialized") ||
              (t.setAttribute("style", i + n.initial),
            ...
            this.isElementInViewport(t, this.options.viewportFactor)
              ? t.getAttribute("data-scroll-reveal-complete")
                ? void 0
                : this.isElementInViewport(t, this.options.viewportFactor)
                ? (t.setAttribute("style", i + n.target + n.transition),
                  void (
                    this.options.reset ||
                    setTimeout(function () {
                      "" != i
              ...
              : void (
                  this.options.reset &&
                  t.setAttribute("style", i + n.initial + n.reset)
                )
          );
        },
        genCSS: function (t) {
          ...
          return {
            ...
            initial:
              ...
              o +
              ");opacity: " +
              (i.opacity || this.options.opacity) +
              ";",
            target:
              "-webkit-transform: translate" +
              n +
...
jQuery(window).scroll(function () {
  "use strict";
  jQuery(this).scrollTop() > $("#banner").height()
  ...
  jQuery(".menu-switch").click(function () {
    "use strict";
    $(this).toggleClass("open"), $("#site-navigation").toggleClass("extend");
  }),
  jQuery(function () {
    "use strict";
  ...
  $(".transparent-section").each(function () {
    ...
    $(this).css({ "background-image": "url(" + t + ")" }),
      $(this).css({ "background-color": "rgb(" + e + ")" }),
      $(this)
        .children(".transparent-content")
        .css({
  ...
  (function (t) {
    "use strict";
    function e(t, e, n, i) {
      if ((i || (i = 1e3), r(e, n), 1 != u.accelerationMax)) {
        var o = +new Date() - h;
        o < u.accelerationDelta &&
          1 < (o = (1 + 30 / o) / 2) &&
          ((o = Math.min(o, u.accelerationMax)), (e *= o), (n *= o)),
          (h = +new Date());
      }
      if (
        (d.push({
        ...
        var s = t === document.body,
          l = function (o) {
            ...
            s
              ? window.scrollBy(r, c)
              : (r && (t.scrollLeft += r), c && (t.scrollTop += c)),
              e || n || (d = []),
    ...
    function i(t, e) {
      for (var n = t.length; n--; ) m[g(t[n])] = e;
      return e;
    }
    function o(t) {
      var e = [],
      ...
      do {
        var r = m[g(t)];
        if (r) return i(e, r);
        if ((e.push(t), o === t.scrollHeight)) {
          if (p.clientHeight + 10 < o) return i(e, document.body);
        } else if (
          t.clientHeight + 10 < t.scrollHeight &&
          ("scroll" ===
            (n = getComputedStyle(t, "").getPropertyValue("overflow-y")) ||
            "auto" === n)
        )
          return i(e, t);
    ...
    function a(t) {
      return 1 <= t
        ...
        : 0 >= t
        ? 0
        : (1 == u.pulseNormalize && (u.pulseNormalize /= s(1)), s(t));
    }
    var l = {
        frameRate: 150,
        animationTime: 1200,
